...
import { changeAvatar, userInfo } from "@/services/authServices";
...
export default function UserProfile() {
  ...
  const { isLoading: infoLoading, mutateAsync: mutateInfo } = useMutation({
    mutationFn: userInfo,
  });
  ...
  const onSubmit = async (values) => {
    ...
    try {
      if (userData) {
        const { data } = await mutateInfo(body);
    ...
    <div className={userProfileStyles}>
      ...
      <div>
        ...
        <div className="flex items-center relative bg-[#2e303880] p-3 m-4 rounded-lg max-[900px]:block">
          ...
          {avatarLoading && <img className="ml-3" src="/loading.gif" width={60} height={60} />}
        </div>
        ...
        >
          ...
          <div className="flex items-center ml-16 max-[900px]:block max-[900px]:ml-0">
            <h6 className={infoTitleStyles}>Phone Number</h6>
            <InputComponent
              name="phoneNumber"
          ...
          {/* Bio */}
          <div className="flex items-center ml-16 max-[900px]:block max-[900px]:ml-0">
            <h6 className={infoTitleStyles}>Biography</h6>
          ...
          {/* City */}
          <div className="flex items-center ml-16 max-[900px]:block max-[900px]:ml-0">
            <h6 className={infoTitleStyles}>City</h6>
            <InputComponent
              name="city"
              formik={userInfoFromik}
          ...
          {/* Province */}
          <div className="flex items-center ml-16 max-[900px]:block max-[900px]:ml-0">
            <h6 className={infoTitleStyles}>Province</h6>
            <InputComponent
              name="province"
              formik={userInfoFromik}
          ...
          {/* Address */}
          <div className="flex items-center ml-16 max-[900px]:block max-[900px]:ml-0">
            <h6 className={infoTitleStyles}>Address</h6>
            <InputComponent
              name="address"
              formik={userInfoFromik}
          ...
          <div className="flex items-center ml-16 max-[900px]:block max-[900px]:ml-0">
            <h6 className={infoTitleStyles}>Social Media</h6>
            <InputComponent
          ...
          <button className={buttonStyles} type="submit" disabled={!userInfoFromik.isValid}>
            {infoLoading ? <Loading w={24} h={20} /> : "Save"}
          </button>
        </form>
      </div>
    </div>
