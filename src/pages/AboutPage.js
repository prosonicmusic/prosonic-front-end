               ...
               <Tilt max={15} speed={400} className="tilt">
                  <div className="teamCard">
                     <div className="cardContent">
                        ...
                        <div className="contentBx">
                           <h3>
                              Arya Pakzad
                              <br />
                              <span className="chngContent">Founder, Music Producer</span>
                           </h3>
                        </div>
                     </div>
                     ...
                     <ul className="sci">
                        ...
                        <li>
                           <a
                              href="https://www.linkedin.com/in/paakzad/"
               ...
               <Tilt max={15} speed={400}>
                  <div className="teamCard">
                     <div className="cardContent">
                        ...
                        <div className="contentBx">
                           <h3>
                              Mahmoud Eslami
                              <br />
                              <span className="chngContent2">Android & Flutter developer</span>
                           </h3>
                        </div>
                     </div>
                     ...
                     <ul className="sci">
                        ...
                        <li>
                           <a
                              href="https://www.linkedin.com/in/mahmoud-eslami/"
                              target="_blank rel=noopener"
                           >
                              <FaLinkedinIn />
                           </a>
